...
PIGEON_ERR_RET pigeon_opengl_create_texture(PigeonOpenGLTexture*, PigeonWGIImageFormat, unsigned width,
...
PIGEON_ERR_RET pigeon_opengl_upload_texture_mip(
	PigeonOpenGLTexture*, unsigned int mip, unsigned int layer, void* data, unsigned int data_size);
...
PIGEON_ERR_RET pigeon_opengl_create_buffer_texture(
	PigeonOpenGLBufferTexture*, unsigned int elements, unsigned int components_per_element);
