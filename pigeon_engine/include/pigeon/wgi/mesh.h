...
PIGEON_ERR_RET pigeon_wgi_create_multimesh(PigeonWGIMultiMesh*,
	PigeonWGIVertexAttributeType attribute_types[PIGEON_WGI_MAX_VERTEX_ATTRIBUTES], unsigned int vertex_count,
	unsigned int index_count, bool big_indices, uint64_t* size, void** vertex_mapping, void** index_mapping);
