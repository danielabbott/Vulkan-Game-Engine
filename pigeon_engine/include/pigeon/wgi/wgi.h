...
PIGEON_ERR_RET pigeon_wgi_start_frame(uint32_t max_draws, uint32_t max_multidraw_draws,
	PigeonWGIShadowParameters shadows[4], unsigned int total_bones, void** draw_objects,
