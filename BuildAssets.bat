...
glslc -O -DDEBUG standard_assets\shaders\downscale.frag -o build\release\standard_assets\shaders\downscale.frag.spv
glslc -O -DDEBUG standard_assets\shaders\ssao.frag -o build\release\standard_assets\shaders\ssao.frag.spv
glslc -O -DDEBUG standard_assets\shaders\kawase_ssao.frag -o build\release\standard_assets\shaders\kawase_ssao.frag.spv
glslc -O -DDEBUG standard_assets\shaders\kawase_rgb.frag -o build\release\standard_assets\shaders\kawase_rgb.frag.spv
glslc -O -DDEBUG standard_assets\shaders\kawase_merge.frag -o build\release\standard_assets\shaders\kawase_merge.frag.spv
glslc -O -DDEBUG standard_assets\shaders\object.frag -o build\release\standard_assets\shaders\object.frag.spv
glslc -O -DDEBUG standard_assets\shaders\object_depth_alpha.frag -o build\release\standard_assets\shaders\object_depth_alpha.frag.spv
glslc -O -DDEBUG standard_assets\shaders\post.frag -o build\release\standard_assets\shaders\post.frag.spv
glslc -O -DDEBUG standard_assets\shaders\skybox.frag -o build\release\standard_assets\shaders\skybox.frag.spv

glslc -O -DDEBUG standard_assets\shaders\fullscreen.vert -o build\release\standard_assets\shaders\fullscreen.vert.spv
glslc -O -DDEBUG standard_assets\shaders\post.vert -o build\release\standard_assets\shaders\post.vert.spv
glslc -O -DDEBUG standard_assets\shaders\skybox.vert -o build\release\standard_assets\shaders\skybox.vert.spv

glslc -O -DDEBUG standard_assets\shaders\object.vert -o build\release\standard_assets\shaders\object.vert.spv
glslc -O -DDEBUG -DOBJECT_DEPTH standard_assets\shaders\object.vert -o build\release\standard_assets\shaders\object.vert.depth.spv
glslc -O -DDEBUG -DOBJECT_DEPTH_ALPHA standard_assets\shaders\object.vert -o build\release\standard_assets\shaders\object.vert.depth_alpha.spv
glslc -O -DDEBUG -DSKINNED standard_assets\shaders\object.vert -o build\release\standard_assets\shaders\object.vert.skinned.spv
glslc -O -DDEBUG -DSKINNED -DOBJECT_DEPTH standard_assets\shaders\object.vert -o build\release\standard_assets\shaders\object.vert.skinned.depth.spv
glslc -O -DDEBUG -DSKINNED -DOBJECT_DEPTH_ALPHA standard_assets\shaders\object.vert -o build\release\standard_assets\shaders\object.vert.skinned.depth_alpha.spv
